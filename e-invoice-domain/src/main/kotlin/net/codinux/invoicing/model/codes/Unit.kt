...
enum class Unit(val code: String, val meaning: String) {
	...
	MKD("MKD", "Square Metre Day"),
	MKM("MKM", "Square Metre Month"),
	MKW("MKW", "Square Metre Week"),
	MLD("MLD", "milliard"),
	MMK("MMK", "square millimetre"),
	MMQ("MMQ", "cubic millimetre"),
	MND("MND", "kilogram, dry weight"),
	MNJ("MNJ", "Mega Joule per Normalised cubic Metre"),
	MPA("MPA", "megapascal"),
	MQD("MQD", "Cubic Metre Day"),
	MQM("MQM", "Cubic Metre Month"),
	MQS("MQS", "cubic metre per second"),
	MQW("MQW", "Cubic Metre Week"),
	MRD("MRD", "Metre Day"),
	MRM("MRM", "Metre Month"),
	MRW("MRW", "Metre Week"),
	...
	XO1("XO1", "Two sided cage on wheels with fixing strap"),
	XO2("XO2", "Trolley"),
	XO3("XO3", "Oneway pallet ISO 0 - 1/2 EURO Pallet"),
	XO4("XO4", "Oneway pallet ISO 1 - 1/1 EURO Pallet"),
	XO5("XO5", "Oneway pallet ISO 2 - 2/1 EURO Pallet"),
	XO6("XO6", "Pallet with exceptional dimensions"),
	XO7("XO7", "Wooden pallet  40 cm x 80 cm"),
	XO8("XO8", "Plastic pallet SRS 60 cm x 80 cm"),
	XO9("XO9", "Plastic pallet SRS 80 cm x 120 cm"),
	...
	XOG("XOG", "Pallet ISO 0 - 1/2 EURO Pallet"),
	XOH("XOH", "Pallet ISO 1 - 1/1 EURO Pallet"),
	XOI("XOI", "Pallet ISO 2 – 2/1 EURO Pallet"),
	XOJ("XOJ", "1/4 EURO Pallet"),
	XOK("XOK", "Block"),
	XOL("XOL", "1/8 EURO Pallet"),
	XOM("XOM", "Synthetic pallet ISO 1"),
	XON("XON", "Synthetic pallet ISO 2"),
	XOP("XOP", "Wholesaler pallet"),
	XOQ("XOQ", "Pallet 80 X 100 cm"),
	XOR("XOR", "Pallet 60 X 100 cm"),
	XOS("XOS", "Oneway pallet"),
	XOT("XOT", "Octabin"),
	XOU("XOU", "Container, outer"),
	XOV("XOV", "Returnable pallet"),
	XOW("XOW", "Large bag, pallet sized"),
	XOX("XOX", "A wheeled pallet with raised rim (81 x 67 x 135)"),
	XOY("XOY", "A Wheeled pallet with raised rim (81 x 72 x 135)"),
	XOZ("XOZ", "Wheeled pallet with raised rim ( 81 x 60 x 16)"),
	XP1("XP1", "CHEP pallet 60 cm x 80 cm"),
	XP2("XP2", "Pan"),
	XP3("XP3", "LPR pallet 60 cm x 80 cm"),
	XP4("XP4", "LPR pallet 80 cm x 120 cm"),
	XPA("XPA", "Packet"),
