...
@Serializable
data class DocumentLineDocument(
  @XmlSerialName(
    value = "LineID",
    prefix = "ram",
  ...
  @XmlElement(value = true)
  val lineStatusCode: LineStatusCode? = null,
  @XmlSerialName(
  ...
  @XmlElement(value = true)
  val lineStatusReasonCode: Code? = null,
  @XmlSerialName(
    value = "CategoryCode",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  ...
  @XmlSerialName(
    value = "ReferenceReferencedDocument",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  )
  @XmlElement(value = true)
  val referenceReferencedDocument: List<ReferencedDocument> = emptyList(),
)
