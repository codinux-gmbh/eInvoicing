...
data class DespatchLine(
  ...
  @XmlElement(value = true)
  val deliveredQuantity: Quantity? = null,
  @XmlSerialName(
  ...
  @XmlElement(value = true)
  val backorderQuantity: Quantity? = null,
  @XmlSerialName(
  ...
  @XmlElement(value = true)
  val backorderReason: List<Text> = emptyList(),
  @XmlSerialName(
  ...
  @XmlElement(value = true)
  val outstandingQuantity: Quantity? = null,
  @XmlSerialName(
  ...
  @XmlElement(value = true)
  val outstandingReason: List<Text> = emptyList(),
  @XmlSerialName(
