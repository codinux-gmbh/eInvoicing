...
@Serializable
data class WorkItemQuantityAnalysis(
  @XmlSerialName(
    value = "ID",
    prefix = "ram",
  ...
  @XmlSerialName(
    value = "ActualQuantityPercent",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  )
  @XmlElement(value = true)
  val actualQuantityPercent: Percent? = null,
  @XmlSerialName(
    value = "TypeCode",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  ...
  @XmlSerialName(
    value = "ActualQuantityWorkItemDimension",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  )
  @XmlElement(value = true)
  val actualQuantityWorkItemDimension: List<WorkItemDimension> = emptyList(),
  @XmlSerialName(
    value = "BreakdownWorkItemQuantityAnalysis",
    prefix = "ram",
    namespace = "urn:un:unece:uncefact:data:standard:ReusableAggregateBusinessInformationEntity:100",
  )
  @XmlElement(value = true)
  val breakdownWorkItemQuantityAnalysis: List<WorkItemQuantityAnalysis> = emptyList(),
  @XmlSerialName(
