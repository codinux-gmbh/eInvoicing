...
data class Person(
  ...
  @XmlElement(value = true)
  val nationalityID: Identifier? = null,
  @XmlSerialName(
    value = "GenderCode",
    prefix = "cbc",
    namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2",
  ...
  @XmlElement(value = true)
  val organizationDepartment: Text? = null,
  @XmlSerialName(
    value = "Contact",
    prefix = "cac",
  ...
  @XmlElement(value = true)
  val identityDocumentReference: List<DocumentReference> = emptyList(),
  @XmlSerialName(
